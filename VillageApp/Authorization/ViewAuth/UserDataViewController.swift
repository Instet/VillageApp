...
class UserDataViewController: UIViewController, ViewAuthorisationProtocol {
    ...
    private lazy var nameTextField = viewElements.getTextFieldForReg(placeholder: StringKey.name.localizedString())
    ...
    private lazy var lastNameTextField = viewElements.getTextFieldForReg(placeholder: StringKey.lastName.localizedString())
    ...
    private lazy var cityTextField = viewElements.getTextFieldForReg(placeholder: StringKey.city.localizedString())
    ...
    private lazy var isMaleButton: UIButton = {
        ...
        button.setTitle(" " + StringKey.male.localizedString(), for: .normal)
    ...
    private lazy var isFemaleButton: UIButton = {
        ...
        button.setTitle(" " + StringKey.female.localizedString(), for: .normal)
        button.titleLabel?.font = .systemFont(ofSize: 14)
        button.setTitleColor(UIColor.createColor(lightMode: .darkText, darkMode: .lightText),
                             for: .normal)
        button.addTarget(self, action: #selector(chooseGender), for: .touchUpInside)
    ...
    private func setupLayout() {
        ...
        self.title = StringKey.basicInfo.localizedString()
